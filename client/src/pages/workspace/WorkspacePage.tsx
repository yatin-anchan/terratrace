...
export default function WorkspacePage() {
  ...
  // Load operation into store so Topbar can read it
  useEffect(() => {
    if (!id) return
  ...
  return (
    <div className={styles.page}>
      ...
      <PanelGroup>
        <ResizablePanel
          defaultWidth={250} minWidth={180} maxWidth={480}
          side="left" collapsed={leftCollapsed}
        ...
        <ResizablePanel
          defaultWidth={240} minWidth={180} maxWidth={480}
          side="right" collapsed={rightCollapsed}
